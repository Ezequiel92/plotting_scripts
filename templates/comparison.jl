############################################################################################
# Template for the comparison of several GADGET3 simulation. 
...
#= 
  ...
  - Comparison of column 2, 3, 4, 5 and 6 vs. column 1 (time):
    - Column 2: mass probability.
    - Column 3: SFR per particle.
    - Column 4: SFR probability
    - Column 5: actual mass.
    - Column 6: actual SFR.
  - Comparison of CPU usage vs. CPU step (`cs_sfr` process only).
...
############################################################################################
# Comparison between models of column 2, 3, 4, 5 and 6 vs. column 1 (time)
############################################################################################
...
############################################################################################
# Comparison between simulations of CPU usage vs. CPU step (`cs_sfr` process only)
############################################################################################
