#= 
  ...
  The snapshots and related data files are located in:
    ...
    ../../sim_data/results/isolated/M019_TEST_04

  The resulting figures, GIFs, and videos will be store in ../../plots/016/.
...
const SNAPSHOTS = [
    ...
    "M019_TEST_03" "snap" "M016 - x4 CPU - Fast" 
    "M019_TEST_04" "snap" "M016 - New simplified use of nh0" 
]
