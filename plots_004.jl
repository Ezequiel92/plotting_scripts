#= 
  ...
  The figures, GIFs and videos will be store in ../../plots/004/, in a directory 
  structure named to describe the contents within.
  
  Plots:
  - Normalized logarithm of the temperature histogram.
  - Logarithms of temperature versus logarithms of density.
  - Kennicutt-Schmidt law (Σ_SFR vs. Σ_ρ), compared with the measured relation.
